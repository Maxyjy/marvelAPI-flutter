...
import 'package:marvel_max/MyColors.dart';
...
import 'package:marvel_max/utils/SliderRightRoute.dart';
...
class SearchEventResultPage extends StatefulWidget {
  final String value;
  final int type;
  SearchEventResultPage({Key key, @required this.value ,this.type}) : super(key: key);
  @override
  _TabPageState createState() => new _TabPageState(value,type);
}

class _TabPageState extends State<SearchEventResultPage>
    with AutomaticKeepAliveClientMixin {
  _TabPageState(String value,int type) {
    this.value = value;
    this.type = type;
  }
  String titleString='Events Result';
  String value;
  int type;
  // 总数
  int _count = 0;
  ...
  Future<bool> getEvents() async {
    ...
    print(eventsEntityList.length.toString());
