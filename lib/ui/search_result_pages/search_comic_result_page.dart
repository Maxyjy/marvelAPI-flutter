...
class SearchComicResultPage extends StatefulWidget {
  final String value;
  final int type;
  SearchComicResultPage({Key key, @required this.value ,this.type}) : super(key: key);
  @override
  _TabPageState createState() => new _TabPageState(value,type);
}

class _TabPageState extends State<SearchComicResultPage>
    with AutomaticKeepAliveClientMixin {
  _TabPageState(String value,int type) {
    this.value = value;
    this.type = type;
  }
  String titleString='Comics Result';
  String value;
  int type;
  // 总数
  int _count = 0;
