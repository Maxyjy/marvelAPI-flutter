...
class SeeAllComics extends StatefulWidget {
  
  final int id;
  final int type;
  SeeAllComics({Key key, @required this.id,this.type}) : super(key: key);

  @override
  _TabPageState createState() => new _TabPageState(id,type);
}

class _TabPageState extends State<SeeAllComics>
  ...
  String _getEventComicsUrl = "/v1/public/events";
  String _getSeriesComicsUrl = "/v1/public/series";
  String _getCharacterComicsUrl = "/v1/public/characters";
  String _getStoriesComicsUrl = "/v1/public/stories";
  String _getCreatorsComicsUrl = "/v1/public/creators";
  ...
  Future<bool> getComics() async {
    ...
    String url;
    if(type==1){url= _host + _getEventComicsUrl+'/'+id.toString()+'/comics';}
    if(type==2){  url=_host + _getSeriesComicsUrl+'/'+id.toString()+'/comics';}
    if(type==3){  url=_host + _getCharacterComicsUrl+'/'+id.toString()+'/comics';}
    if(type==4){  url=_host + _getStoriesComicsUrl+'/'+id.toString()+'/comics';}
    if(type==5){  url=_host + _getCreatorsComicsUrl+'/'+id.toString()+'/comics';}
    print(url);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: <Widget>[
            Text('See All Comics',textScaleFactor: 1.0,),
