...
class SeeAllCreators extends StatefulWidget {
  final int id;
  final int type;
  SeeAllCreators({Key key, @required this.id,this.type}) : super(key: key);
...
class _TabPageState extends State<SeeAllCreators> with AutomaticKeepAliveClientMixin{
  ...
  String _getEventCreatorsUrl="/v1/public/events";
  String _getComicCreatorsUrl="/v1/public/comics";
  String _getSeriesCreatorsUrl="/v1/public/series";
  String _getStoriesCreatorsUrl="/v1/public/stories";
  String _getCreatorCreatorsUrl="/v1/public/creators";
  ...
  Future<bool> getCreators() async{
    ...
    if(type==1){url=_host+_getEventCreatorsUrl+'/'+id.toString()+'/creators';}
    if(type==2){url=_host+_getComicCreatorsUrl+'/'+id.toString()+'/creators';}
    if(type==3){url=_host+_getSeriesCreatorsUrl+'/'+id.toString()+'/creators';}
    if(type==4){url=_host+_getStoriesCreatorsUrl+'/'+id.toString()+'/creators';}
    if(type==5){url=_host+_getCreatorCreatorsUrl+'/'+id.toString()+'/creators';}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: <Widget>[
            Text('See All Creators',textScaleFactor: 1.0,),
