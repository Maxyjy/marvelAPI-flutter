...
class _TabPageState extends State<CharactersTabPage>
  ...
  Widget buildSeriesDescText(TestDataResult testDataResult) {
    if (testDataResult.description == null ||
        testDataResult.description.length == 0) {
      return new Column(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      "Loading Characters Data From Marvel Universe..",
                      textScaleFactor: 1.0,
                      style: TextStyle(
                          fontSize: 12, color: MyColors.detail_text_color),
                    ),
                  )
                ],
              ),
            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return Container(
                  ...
                  child: Container(
                    decoration:
                        new BoxDecoration(color: MyColors.image_holder_bg),
                    child: Row(
                      children: <Widget>[
                        Container(
                          height: 100.0,
                          child: AspectRatio(
                            ...
                            child: RaisedButton(
                              ...
                              child: Container(
                                ...
                                height: 100.0,
                                child: Image.network(
                                  charactersEntityList[index].thumbnail.path +
                                      '.' +
                                      charactersEntityList[index]
                                          .thumbnail
                                          .extension,
                                  fit: BoxFit.fill,
                                ),
