...
class CreatorsTabPage extends StatefulWidget {
...
class _TabPageState extends State<CreatorsTabPage> with AutomaticKeepAliveClientMixin{
  // 总数
  int _count = 0;
  int total;
  ...
  Future<bool> getFreshCreators() async{
    ...
    offset=offset+creators.data.count;
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(
                          "Loading Creators Data From Marvel Universe..",
                          textScaleFactor: 1.0,
